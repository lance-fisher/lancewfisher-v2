...
**Problem**: The 4-step booking flow (provider -> date -> time -> review) always showed hardcoded "Scarlet RF Microneedling, Casey Park, Feb 14, $1,000" regardless of what the user selected.

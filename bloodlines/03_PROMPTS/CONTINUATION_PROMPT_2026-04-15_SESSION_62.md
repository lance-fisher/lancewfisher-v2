...
15. docs/BLOODLINES_STATE_OF_GAME_REPORT_2026-04-15_SESSION_46.md through SESSION_61.md
16. tasks/todo.md
17. HANDOFF.md
...
Implement lesser-house marital anchoring and controlled mixed-bloodline branch pressure.

Requirements for that work:
- It must deepen the live marriage and lesser-house lane, not replace it.
- It must interact with at least two already-live systems.
- It must make active or dissolved marriages materially change cadet-house loyalty, stability, defection pressure, or branch identity.
- It must become legible through an existing dynasty surface.
- It must preserve continuity through snapshot export and restore.

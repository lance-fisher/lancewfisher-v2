...
15. docs/BLOODLINES_STATE_OF_GAME_REPORT_2026-04-15_SESSION_46.md through SESSION_76.md
16. tasks/todo.md
17. HANDOFF.md
...
- Session 76: enemy captive-recovery timing now reacts more sharply when held captives are the leading source of world pressure, and Stonehelm launches live rescue or ransom backlash through the dynasty-operations lane.

Next required action:
Implement source-aware territory-expansion backlash when broad territorial expansion, not off-home holdings specifically, is the leading source of world pressure.

...
15. docs/BLOODLINES_STATE_OF_GAME_REPORT_2026-04-15_SESSION_46.md through SESSION_51.md
16. tasks/todo.md
17. HANDOFF.md
...
Implement faith-compatibility weighting in AI marriage proposal and acceptance logic.

Requirements for that work:
- It must affect AI proposal or acceptance behavior in simulation.
- It must read real faith and doctrine state, not lore labels.

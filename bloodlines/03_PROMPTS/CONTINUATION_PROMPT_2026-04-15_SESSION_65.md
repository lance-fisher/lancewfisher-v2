...
15. docs/BLOODLINES_STATE_OF_GAME_REPORT_2026-04-15_SESSION_46.md through SESSION_64.md
16. tasks/todo.md
17. HANDOFF.md
...
Implement minor-house opportunism under parent-realm world pressure.

Requirements for that work:
- It must affect real runtime, not only messaging.
- It must connect world pressure to at least two already-live systems.
- One of those systems must be breakaway minor-house levy growth, retake behavior, or territorial opportunism.

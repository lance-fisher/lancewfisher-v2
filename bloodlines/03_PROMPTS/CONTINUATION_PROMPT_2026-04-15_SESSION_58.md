...
15. docs/BLOODLINES_STATE_OF_GAME_REPORT_2026-04-15_SESSION_46.md through SESSION_57.md
16. tasks/todo.md
17. HANDOFF.md
...
- Session 55: espionage now creates live rival-court intelligence reports, assassination now kills real bloodline members with command, legitimacy, succession, and hostility consequence, the dynasty panel exposes covert pressure, Stonehelm can retaliate through espionage and assassination, and restore continuity now covers `dynastyIntel` ids.
- Session 56: missionary pressure and holy war declaration are now live faith operations with faith-intensity fuel, hostility shifts, territorial or legitimacy pressure, faith-panel legibility, AI faith reactivity, and restore continuity for `faithHolyWar` ids.
- Session 57: marriage proposals and approvals now run through live household authority, require an offering envoy, impose legitimacy strain under regency, surface through the dynasty panel, and persist through restore.

Next required action:
Implement field-water attrition and desertion as the next sustained-dehydration military consequence layer.

Requirements for that work:
- It must extend the already-live field-water lane, not replace it.
- It must change simulation state materially after prolonged dehydration, not only movement and attack modifiers.
...
- It must survive save and restore if new state is introduced.

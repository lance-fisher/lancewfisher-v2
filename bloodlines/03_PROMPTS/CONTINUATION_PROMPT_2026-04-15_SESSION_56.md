...
15. docs/BLOODLINES_STATE_OF_GAME_REPORT_2026-04-15_SESSION_46.md through SESSION_55.md
16. tasks/todo.md
17. HANDOFF.md
...
Implement faith operations, specifically missionary conversion and holy war declaration, as live extensions of the existing faith and dynasty runtime.

Requirements for that work:
- It must affect runtime state, not only lore labels.
- It must interact with at least two already-live systems.
- It must touch faith commitment, pressure or hostility, and player or AI decision-making.

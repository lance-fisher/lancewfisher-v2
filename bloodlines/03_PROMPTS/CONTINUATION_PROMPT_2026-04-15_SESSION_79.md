...
15. docs/BLOODLINES_STATE_OF_GAME_REPORT_2026-04-15_SESSION_46.md through SESSION_78.md
16. tasks/todo.md
17. HANDOFF.md
...
- Session 78: Hartvale Verdant Warden now provides live settlement-defense and local-loyalty support, surfaces that support through the Loyalty and Fort dashboard pills, and sharpens Stonehelm keep-assault caution.

Next required action:
Advance `Scout Rider` into a live stage-2 cavalry and raiding lane.

Requirements for that work:
- It must affect runtime state, not only stats or labels.
- It must touch at least two already-live systems, including logistics, resource nodes, territorial pressure, or AI response where canon supports it.

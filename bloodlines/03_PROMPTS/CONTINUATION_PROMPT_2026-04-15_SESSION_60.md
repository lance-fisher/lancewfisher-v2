...
15. docs/BLOODLINES_STATE_OF_GAME_REPORT_2026-04-15_SESSION_46.md through SESSION_59.md
16. tasks/todo.md
17. HANDOFF.md

Current live state to preserve:
- Session 58: prolonged critical dehydration now causes real field-water attrition and desertion risk, commander presence buffers it, Stonehelm recoils from breaking lines, and restore preserves collapse state.
- Session 59: dynasty counter-intelligence is now live as a timed court watch that lowers espionage and assassination success, protects core bloodline roles, records interceptions, surfaces in the dynasty panel, survives restore, and triggers Stonehelm defensive reciprocity.

Next required action:
Implement the next world-pressure and late-stage escalation layer.

Requirements for that work:
- It must affect live simulation, not just labels.
- It must interact with at least two already-live systems.
- It must increase world or rival pressure against consolidation, not remain passive flavor.
- It must become legible through an existing world, dashboard, alert, or panel surface.
- It must be AI-aware or otherwise change world behavior, not stay player-only.

...
15. docs/BLOODLINES_STATE_OF_GAME_REPORT_2026-04-15_SESSION_46.md through SESSION_70.md
16. tasks/todo.md
17. HANDOFF.md
...
- Session 69: Ironmark `axeman` is now a live house-gated unique unit with heavier blood levy and blood-production burden.
- Session 70: Ironmark-controlled AI now recruits `axeman` through the same shared barracks gate, falls back to lighter infantry when blood-production burden is already high, and surfaces that decision through the message log.

Next required action:
Implement source-aware world pressure and off-home targeting follow-up.

Requirements for that work:
- It must expose why a realm is under world pressure through an existing legibility surface.
- It must affect world or AI behavior, not only tooltip text.
- It should make continental or off-home overextension materially matter when that is the leading pressure source.
- It must survive snapshot continuity.

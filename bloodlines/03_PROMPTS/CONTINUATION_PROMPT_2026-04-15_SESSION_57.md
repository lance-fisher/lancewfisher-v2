...
15. docs/BLOODLINES_STATE_OF_GAME_REPORT_2026-04-15_SESSION_46.md through SESSION_56.md
16. tasks/todo.md
17. HANDOFF.md
...
Implement marriage-governance controls by head of household.

Requirements for that work:
- Marriage proposal and acceptance authority must run through the head of bloodline or an explicitly governed dynastic authority path.
- It must affect live runtime state, not only proposal text.
- It must interact with at least two already-live systems.
- It must touch legitimacy, dynasty politics, or faction relations in a measurable way.

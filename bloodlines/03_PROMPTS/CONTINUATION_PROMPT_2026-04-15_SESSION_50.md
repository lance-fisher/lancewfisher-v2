# Bloodlines Continuation Prompt, Session 50
...
15. `docs/BLOODLINES_STATE_OF_GAME_REPORT_2026-04-15_SESSION_44.md`
16. `docs/BLOODLINES_STATE_OF_GAME_REPORT_2026-04-15_SESSION_45.md`
17. `docs/BLOODLINES_STATE_OF_GAME_REPORT_2026-04-15_SESSION_46.md`
18. `docs/BLOODLINES_STATE_OF_GAME_REPORT_2026-04-15_SESSION_47.md`
19. `docs/BLOODLINES_STATE_OF_GAME_REPORT_2026-04-15_SESSION_48.md`
20. `docs/BLOODLINES_STATE_OF_GAME_REPORT_2026-04-15_SESSION_49.md`
21. `tasks/todo.md`
22. `HANDOFF.md`
...
- Session 47: the defected minor house now claims a real stabilized border march with food and influence trickle.
- Session 48: `minor_house` AI is now live for territorial defense, retake pressure, regroup behavior, and dynasty-panel legibility.
- Session 49: snapshot restore now rebuilds live prefix-based counters so post-restore dynamic ids do not collide.

Highest-leverage next action:

Implement **minor-house territorial levy and retinue growth** as the next operational layer for breakaway factions.

Concrete target:

1. Read `src/game/core/ai.js`, `src/game/core/simulation.js`, `src/game/main.js`, and the Session 47 through 49 reports.
2. Make the held breakaway march capable of raising or attracting additional local retinue in a way that touches at least:
   - territorial control,
   - resource pressure,
   - military presence,
   - save/restore continuity,
   - legibility.
3. Keep it additive. Do not replace kingdom production. Do not reduce the cadet-breakaway arc into a generic rebel token.
4. Surface the new growth layer through existing legibility surfaces such as the dynasty panel, message log, control-point text, or debug overlay.

...
15. docs/BLOODLINES_STATE_OF_GAME_REPORT_2026-04-15_SESSION_46.md through SESSION_73.md
16. tasks/todo.md
17. HANDOFF.md
...
- Session 73: enemy missionary and holy-war timing now react more sharply when active holy war is the leading source of world pressure, and the message log surfaces that backlash.

Next required action:
Implement source-aware covert backlash when hostile operations are the leading source of world pressure.

Requirements for that work:
- It must affect counter-intelligence or covert AI behavior in simulation.

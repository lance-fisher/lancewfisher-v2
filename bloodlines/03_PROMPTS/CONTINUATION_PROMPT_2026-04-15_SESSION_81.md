...
15. docs/BLOODLINES_STATE_OF_GAME_REPORT_2026-04-15_SESSION_46.md through SESSION_80.md
16. tasks/todo.md
17. HANDOFF.md
...
Extend Scout Rider into interception of live field-logistics carriers, starting with `supply_wagon`, and make that moving-cavalry pressure matter to already-live sustainment systems.

Requirements for that work:
- It must affect a moving live logistics carrier, not only buildings or fixed seams.
- It must touch at least two already-live systems, including siege-supply continuity, field-water sustainment, territorial pressure, or AI escort / counter-screen behavior where canon supports it.

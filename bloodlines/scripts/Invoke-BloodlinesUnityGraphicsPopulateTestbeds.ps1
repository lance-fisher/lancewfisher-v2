param(
    ...
    [string]$LogFile = "D:\ProjectsHome\Bloodlines\artifacts\unity-graphics-testbed-populate.log"
)
...
if ($process.ExitCode -ne 0) {
    throw "Unity batchmode testbed population failed with exit code $($process.ExitCode). See '$LogFile'."
}

Write-Host "Bloodlines Unity graphics testbed population completed."
Write-Host "Method: Bloodlines.EditorTools.GraphicsVisualTestbedPopulate.RunBatchPopulateVisualTestbedScenes"

...
- Status: active
- Branch Prefix: `claude/unity-ai-counter-intelligence-dispatch` (sub-slice 32); prior `claude/unity-ai-sabotage-dispatch-resolution` (sub-slice 31); prior claude/unity-ai-assassination-dispatch-resolution (sub-slice 30), claude/unity-ai-captive-rescue-and-ransom-resolution (Bundle 5: sub-slices 28+29), claude/unity-ai-divine-right-resolution (sub-slice 27), claude/unity-ai-holy-war-resolution (sub-slice 26), claude/unity-ai-missionary-resolution-rebased (Bundle 4: sub-slice 25), claude/unity-ai-captive-rescue-and-ransom-execution (Bundle 3: sub-slices 23+24), claude/unity-ai-holy-war-and-divine-right-execution (Bundle 2: sub-slices 21+22), claude/unity-ai-captive-state-and-missionary-execution (Bundle 1: sub-slices 19+20), claude/unity-ai-dynasty-operations-foundation (18), claude/unity-ai-narrative-back-wire (17), claude/unity-ai-narrative-message-bridge (16), claude/unity-ai-pact-break-expiration (15), claude/unity-ai-pact-proposal-execution (14), claude/unity-ai-lesser-house-promotion (13), claude/unity-ai-marriage-acceptance-terms (12), claude/unity-ai-marriage-accept-effects (11), claude/unity-ai-marriage-strategic-profile (10), claude/unity-ai-marriage-inbox-accept (9), codex/unity-ai-command-dispatch (8) also landed; future sub-slices on new branches
- Owner Agent: claude-code
- Owned Paths (exclusive):
  ...
  - `unity/Assets/_Bloodlines/Code/AI/ActiveHolyWarElement.cs`
  - `unity/Assets/_Bloodlines/Code/AI/AIHolyWarResolutionSystem.cs`
  - `unity/Assets/_Bloodlines/Code/AI/AIDivineRightResolutionSystem.cs`
  - `unity/Assets/_Bloodlines/Code/AI/AICaptiveRescueResolutionSystem.cs`
  - `unity/Assets/_Bloodlines/Code/AI/AICaptiveRansomResolutionSystem.cs`
  - `unity/Assets/_Bloodlines/Code/AI/DynastyOperationAssassinationComponent.cs`
  - `unity/Assets/_Bloodlines/Code/AI/AIAssassinationExecutionSystem.cs`
  - `unity/Assets/_Bloodlines/Code/AI/AIAssassinationResolutionSystem.cs`
  - `unity/Assets/_Bloodlines/Code/Debug/BloodlinesDebugCommandSurface.AssassinationResolution.cs`
  - `unity/Assets/_Bloodlines/Code/Editor/BloodlinesAssassinationResolutionSmokeValidation.cs`
  - `scripts/Invoke-BloodlinesUnityAssassinationResolutionSmokeValidation.ps1`
  - `unity/Assets/_Bloodlines/Code/AI/DynastyOperationSabotageComponent.cs`
  - `unity/Assets/_Bloodlines/Code/AI/AISabotageExecutionSystem.cs`
  - `unity/Assets/_Bloodlines/Code/AI/AISabotageResolutionSystem.cs`
  - `unity/Assets/_Bloodlines/Code/Debug/BloodlinesDebugCommandSurface.SabotageResolution.cs`
  - `unity/Assets/_Bloodlines/Code/Editor/BloodlinesSabotageResolutionSmokeValidation.cs`
  - `scripts/Invoke-BloodlinesUnitySabotageResolutionSmokeValidation.ps1`
  - `unity/Assets/_Bloodlines/Code/AI/DynastyCounterIntelligenceWatchElement.cs`
  - `unity/Assets/_Bloodlines/Code/AI/DynastyOperationCounterIntelligenceComponent.cs`
  - `unity/Assets/_Bloodlines/Code/AI/AICounterIntelligenceExecutionSystem.cs`
  - `unity/Assets/_Bloodlines/Code/AI/AICounterIntelligenceResolutionSystem.cs`
  ...
  - `unity/Assets/_Bloodlines/Code/AI/AIFaithCommitmentSystem.cs`
  ...
  - `unity/Assets/_Bloodlines/Code/Debug/BloodlinesDebugCommandSurface.CaptiveRansomResolution.cs`
  - `unity/Assets/_Bloodlines/Code/Editor/BloodlinesHolyWarResolutionSmokeValidation.cs`
  - `unity/Assets/_Bloodlines/Code/Editor/BloodlinesDivineRightResolutionSmokeValidation.cs`
  - `unity/Assets/_Bloodlines/Code/Editor/BloodlinesCaptiveRescueResolutionSmokeValidation.cs`
  - `unity/Assets/_Bloodlines/Code/Editor/BloodlinesCaptiveRansomResolutionSmokeValidation.cs`
  - `scripts/Invoke-BloodlinesUnityHolyWarResolutionSmokeValidation.ps1`
  - `scripts/Invoke-BloodlinesUnityDivineRightResolutionSmokeValidation.ps1`
  - `scripts/Invoke-BloodlinesUnityCaptiveRescueResolutionSmokeValidation.ps1`
  - `scripts/Invoke-BloodlinesUnityCaptiveRansomResolutionSmokeValidation.ps1`
...
- Browser Reference:
  ...
  - Sub-slice 26: `src/game/core/simulation.js` `tickDynastyOperations` holy_war branch (~5590-5645): declaration resolution at ResolveAtInWorldDays; `createHolyWarEntry` (~10505-10520) ported as ActiveHolyWarElement buffer on source faction; initial intensity boost `max(3, intensityPulse * 2)` to source FaithStateComponent.Intensity (simulation.js:5611); initial loyalty drain `max(2, loyaltyPulse)` to target lowest control point or FactionLoyaltyComponent (simulation.js:5615-5619); conviction events to source (dark=Desecration+2 / light=Oathkeeping+2) and target (Stewardship-1) if ConvictionComponent present (simulation.js:5622-5635); operation finalized (Active=false). War-tick sustained effects from `tickFaithHolyWars` (~4160-4215): sustained loyalty drain per frame `loyaltyPulse * SUSTAINED_LOYALTY_DRAIN_MULTIPLIER(1.5) * dt` on target lowest control point (simulation.js:9777); pulse every PulseIntervalInWorldDays=60 (30 real seconds at canonical DaysPerRealSecond=2, simulation.js:9776): source intensity += IntensityPulse, target control-point loyalty -= LoyaltyPulse; entry pruned at ExpiresAtInWorldDays with player-related expiration narrative. Deferred: legitimacy drain during sustained phase (adjustLegitimacy, simulation.js:4186; no canonical Legitimacy field outside dynasty-core lane); ensureMutualHostility at declaration (simulation.js:5600; no hostility component pair yet); full conviction event recording deferred if ConvictionComponent absent.
  - Sub-slices 28+29 (Bundle 5): `src/game/core/simulation.js` `tickDynastyOperations` rescue branch (~5861-5895): successScore>=0 gate; releaseCapturedMember; legitimacy recovery (deferred); stewardship+2 conviction on source (success); captorFaction.resources.influence += max(6, round(escrowInfluence*0.2)) + stewardship+1 on captor (failure). `tickDynastyOperations` ransom branch (~5838-5858): grantResources to captor; releaseCapturedMember; legitimacy recovery (deferred); oathkeeping+1 on source; stewardship+1 on captor.
  - Sub-slice 27: `src/game/core/simulation.js` `tickFaithDivineRightDeclarations` (~10747-10782): per-tick failure check fires when source loses faith commitment (SelectedFaith==None or Intensity below 80 threshold) -- drains source FaithStateComponent.Intensity by 18 (DIVINE_RIGHT_FAILURE_INTENSITY_LOSS, simulation.js:9783), fires conviction event (+3 desecration for dark / +3 oathkeeping for light, deferred dispatch-time event from startDivineRightDeclaration simulation.js:10806), pushes failure narrative (simulation.js:10708-10712), finalizes operation (Active=false). Success fires when inWorldDays >= ResolveAtInWorldDays and source still holds faith commitment -- fires same conviction event, pushes completion narrative (simulation.js:10736-10740), finalizes operation. Deferred: legitimacy +12 on success (adjustLegitimacy, simulation.js:10717; no canonical Legitimacy field outside dynasty-core lane); legitimacy -10 on failure (simulation.js:10707; same); game-over signaling (state.meta.status="won"/"lost"; no game-status component in this lane); cooldown surface after failure (DIVINE_RIGHT_RELAUNCH_COOLDOWN_SECONDS=75 at simulation.js:9785; recognition share check deferred as in sub-slice 22; apex structure check deferred).
  ...
  - Sub-slice 30: `src/game/core/ai.js` assassination dispatch block ~2435-2457; `src/game/core/simulation.js` `startAssassinationOperation` (~10912-10950), `getAssassinationTerms` (~10284-10323), `getAssassinationContest` (~10214-10255), `applyAssassinationEffect` (~5390-5433), resolution branch of `tickDynastyOperations` (~5752-5830). Browser constants: ASSASSINATION_COST={gold:85,influence:28} (simulation.js:9765), ASSASSINATION_DURATION_SECONDS=34 (simulation.js:9769). Target selection: `pickAiAssassinationTarget` (~2981-3009) priority Commander>HeirDesignate>HeadOfBloodline>Governor>Spymaster by renown tiebreak. Dispatch gates ported: source!=target, target faction+dynasty exists, at least one available target member, no existing active assassination on same member, source has Spymaster/Diplomat/Merchant operator, source Gold>=85 + Influence>=28, DynastyOperationLimits.HasCapacity. Contest formula simplified (deferred: locationProfile exposureBonus, faith ward defense bonus, bloodline protection bonus, counter-intel bonus). Resolution success: member.status=Fallen, FallenAtWorldSeconds, Ruthlessness+2 on source via ConvictionScoring.ApplyEvent, Stewardship-1 on target if Governor, DynastyFallenLedger entry, clearCommanderLinks, clearGovernorLinks, ensureMutualHostility, assassination narrative. Resolution failure: influence refund max(8,round(escrow*0.3)) to target, Stewardship+1 on target, interception narrative. Deferred: legitimacy loss on commander/governor kill (no canonical Legitimacy field outside dynasty-core lane), applySuccessionRipple (complex succession), tickMarriageDissolutionFromDeath (marriage-parity lane), recordCounterIntelligenceInterception on failure (player-covert-ops lane boundary). Always flips Active=false.
  - Sub-slice 31: `src/game/core/ai.js` sabotage dispatch block ~2321-2370; `src/game/core/simulation.js` `startSabotageOperation` (~10952-10990), `getSabotageTerms` (~9900-9957), `applySabotageEffect` (~10992-11024), `pickAiSabotageTarget` (~2946-2979), resolution branch of `tickDynastyOperations` (~5464-5514). SABOTAGE_COSTS/SABOTAGE_DURATIONS (simulation.js:9739-9751): gate_opening 60g/18i/28s, fire_raising 40g/12i/24s, supply_poisoning 50g/15i/30s, well_poisoning 70g/20i/32s. Target priority: supply_camp->supply_poisoning, gatehouse->gate_opening, well->well_poisoning, farm/barracks->fire_raising. Contest: operatorRenown+45 vs fortTier*12+(spymaster?10:0). Effects: supply_poisoning: BuildingRaidStateComponent; well_poisoning: RealmConditionComponent.WaterStrainStreak+=2; gate_opening/fire_raising: structural deferred. Conviction: Desecration+2 (poisoning) or Ruthlessness+2 (others). Failure: Stewardship+1 on target. Void: building destroyed before resolution (silent finalize).
  - Sub-slice 32: `src/game/core/ai.js` counter-intelligence dispatch block ~2372-2397; `shouldAiRaiseCounterIntelligence` (~2859-2878); `src/game/core/simulation.js` `startCounterIntelligenceOperation` (~10837-10874), `getCounterIntelligenceTerms` (~10324-10360), `buildCounterIntelligenceTerms` (~9987-10027), `createCounterIntelligenceWatch` (~10160-10185), resolution branch of `tickDynastyOperations` (~5650-5679). COUNTER_INTELLIGENCE_COST={gold:60,influence:18} (simulation.js:9753), COUNTER_INTELLIGENCE_DURATION_SECONDS=18 (simulation.js:9754), COUNTER_INTELLIGENCE_WATCH_DURATION_SECONDS=150 (simulation.js:9755). WatchStrength formula: max(8, round(operatorRenown*0.5+10+fortTier*3)); Unity simplifications: ward+5, loyalty support, legitimacy support, instability penalty all deferred (surfaces not yet ported). Resolution is deterministic (no roll): createCounterIntelligenceWatch adds DynastyCounterIntelligenceWatchElement to source faction buffer (max 2, pruned by expiresAt); Stewardship+1 on source; narrative. Timer cap: HostileOperationsSourceFocused -> min 4s. Fire gate: HasActiveCounterIntelligenceWatch suppresses fire. Timer reset: 190s.
- Current Branch In Flight: `claude/unity-ai-counter-intelligence-dispatch`
- Last Slice Handoff: `docs/unity/session-handoffs/2026-04-24-unity-ai-counter-intelligence-dispatch.md`

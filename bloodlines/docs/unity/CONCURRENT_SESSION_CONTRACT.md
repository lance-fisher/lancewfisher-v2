...
- Last Updated By: claude-code-2026-04-22
- Supersedes: revision 90 (Records the validated `dynasty-political-events` lane, notes the follow-on dynasty political event smoke wrapper, and retires the implementation phase of `dynasty-succession-crisis` after its validated landing onto the overnight integration branch.)
...
- Current Branch In Flight: `codex/unity-dynasty-political-events`

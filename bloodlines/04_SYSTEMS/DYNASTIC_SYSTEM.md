...
- Training paths: military command, governance, religious leadership, diplomacy, covert operations, economic stewardship
- Become active leaders upon maturity
- Possible roles: commanders, governors, diplomats, ideological leaders
...
- Execution
- Ransom
- Marriage into the dynasty (if polygamy practiced)
